...
const allPosts = [
  { id: 1,  date: '04 Sep, 2023', author: 'Rivanur', comments: 2, category: 'Maintenance', img: 'https://images.unsplash.com/photo-1486262715619-3417ca499161?w=800&h=500&fit=crop',  title: 'Comprehensive Car Care for Peak Performance',          excerpt: 'Discover the essential steps every car owner should take to maintain peak performance year-round. From fluid checks to tyre pressure — we cover it all.' },
  { id: 2,  date: '12 Oct, 2023', author: 'James W',  comments: 5, category: 'Engine',      img: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&h=500&fit=crop',  title: 'How to Modify Your Car Engine Properly',              excerpt: 'Engine modifications can unlock serious power — but only when done right. Our master technicians share safe, legal and effective upgrade strategies.' },
  { id: 3,  date: '21 Nov, 2023', author: 'Rivanur', comments: 3, category: 'Tips',        img: 'https://images.unsplash.com/photo-1609440226919-fe7b9c25e541?w=800&h=500&fit=crop',  title: 'The Ultimate Car Servicing Checklist',                excerpt: 'Never miss a service item again. This comprehensive checklist covers every point your mechanic should inspect at every scheduled service.' },
  { id: 4,  date: '08 Dec, 2023', author: 'Maria G',  comments: 7, category: 'Maintenance', img: 'https://images.unsplash.com/photo-1552820728-8ac41f1ce891?w=800&h=500&fit=crop',  title: 'A Holistic Approach to Super Car Maintenance',        excerpt: 'High-performance vehicles demand a different level of attention. Learn the specialised maintenance routines that keep supercars at their best.' },
  { id: 5,  date: '15 Jan, 2024', author: 'David K',  comments: 4, category: 'Tips',        img: 'https://images.unsplash.com/photo-1552512019-4a632b6a4d82?w=800&h=500&fit=crop',  title: 'Insider Tips for Effective Car Maintenance',          excerpt: 'Professional mechanics share their best-kept secrets for keeping your car in showroom condition without breaking the bank.' },
  { id: 6,  date: '02 Feb, 2024', author: 'Rivanur', comments: 6, category: 'Engine',      img: 'https://images.unsplash.com/photo-1487754180144-351b8e906e8f?w=800&h=500&fit=crop',  title: 'Modern Strategies for Super Car Maintenance',         excerpt: 'Technology is changing how we service cars. Explore the latest diagnostic tools, OBD-II scanners and AI-assisted maintenance planning.' },
  { id: 7,  date: '19 Mar, 2024', author: 'James W',  comments: 2, category: 'Service',     img: 'https://images.unsplash.com/photo-1601584942197-04bbb2f551b8?w=800&h=500&fit=crop',  title: 'The Science of Effective Car Servicing',              excerpt: 'What actually happens during a professional service? We break down each step and explain the science behind why it matters for longevity.' },
  { id: 8,  date: '05 Apr, 2024', author: 'Maria G',  comments: 9, category: 'Tips',        img: 'https://images.unsplash.com/photo-1557821552-17105176677c?w=800&h=500&fit=crop',  title: 'Insider Tips for Keeping Your Car Like New',          excerpt: 'Small habits make a big difference. From parking habits to wash techniques, these pro tips will keep your car looking and running like new.' },
  { id: 9,  date: '22 May, 2024', author: 'David K',  comments: 3, category: 'Service',     img: 'https://images.unsplash.com/photo-1489824904134-891ab64532f1?w=800&h=500&fit=crop',  title: 'Unlocking the Secrets of Efficient Car Servicing',    excerpt: 'Efficient servicing saves time and money. Learn how Garix streamlines every job with precision planning, genuine parts and expert hands.' },
  { id: 10, date: '10 Jun, 2024', author: 'Rivanur', comments: 5, category: 'Maintenance', img: 'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?w=800&h=500&fit=crop', title: 'Why Regular Oil Changes Are Non-Negotiable',           excerpt: 'Skipping an oil change can cost you thousands. We explain exactly what happens inside your engine when oil goes past its service life.' },
  { id: 11, date: '28 Jul, 2024', author: 'James W',  comments: 4, category: 'Engine',      img: 'https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?w=800&h=500&fit=crop', title: 'Turbocharger Maintenance: Everything You Need to Know', excerpt: 'Turbocharged engines deliver incredible performance — but they need specific care. Here is your complete guide to turbo maintenance.' },
  { id: 12, date: '14 Aug, 2024', author: 'Maria G',  comments: 8, category: 'Tips',        img: 'https://images.unsplash.com/photo-1494145904049-0dca7b3d1f6c?w=800&h=500&fit=crop', title: 'Brake Maintenance: Safety Tips Every Driver Must Know', excerpt: 'Your brakes are your most critical safety system. Learn the warning signs of worn brakes and how to stay safe on every journey.' },
];
...
const BlogPage = () => {
  ...
  return (
    <>
      ...
      <section style={{
        marginTop: '70px',
        backgroundImage: "linear-gradient(rgba(0,0,0,0.78),rgba(0,0,0,0.78)), url('https://images.unsplash.com/photo-1552512019-4a632b6a4d82?w=1920&h=600&fit=crop')",
